...
// ✅ Add this import (adjust path if your api file is elsewhere)
...
export default function ProfileDetailsPage() {
  ...
  // ✅ Convert "January 1, 1994" → "1994-01-01" for DB
  ...
  const handleContinue = async () => {
    try {
      ...
      // Save basic influencer profile fields
  ...
  return (
    <>
      ...
      {/* 🔽 Bottom-sheet “Why do you ask this?” Dialog */}
