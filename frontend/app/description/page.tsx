...
export default function DescriptionPage() {
  ...
  useEffect(() => {
    ...
    if (primary.includes('athlete') || primary.includes('sports')) {
      ...
      primary.includes('vegan') ||
      primary.includes('cannabis') ||
      primary.includes('adventure') ||
      primary.includes('outdoors') ||
      primary.includes('automotive') ||
      primary.includes('skilled')
    ) {
      typeBased = [
  ...
  // ✅ NEW async continue: save description + complete onboarding
