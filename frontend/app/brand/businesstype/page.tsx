  ...
  const options: BusinessOption[] = [
    {
      ...
      icon: (
        ...
        >
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6M9 16h6M12 8v8M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h14l1.24-5.52A2 2 0 0020.28 6H6.76M7 13l-1 5h14M7 13H5m2 0l.4-2" />
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7M3 7l1-4h16l1 4M7 13h3v7H7v-7zm7 0h3v7h-3v-7z" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zm0 8v.01" />
        </svg>
      ),
    },
  ]
