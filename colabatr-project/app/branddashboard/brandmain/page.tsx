      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-wrap gap-2 text-sm">
            ...
            <button className="px-3 py-1 border border-gray-300 rounded-full bg-gray-100 hover:bg-indigo-50">Instagram</button>
            <button className="px-3 py-1 border border-gray-300 rounded-full bg-gray-100 hover:bg-indigo-50">TikTok</button>
            <button className="px-3 py-1 border border-gray-300 rounded-full bg-gray-100 hover:bg-indigo-50">YouTube</button>
