    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          {!isVerifying && !isClaimingUsername ? (
            <>
            ...
            <>
              ...
              <p className="text-gray-600 mb-6">
                We sent an email to {formData.email}. Check your inbox and enter the 6 digit code to verify your email.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600 text-center text-2xl tracking-widest font-mono"
                  />
                </div>
